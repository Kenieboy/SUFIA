...
function DailyConsumptionEditEntry() {
  ...
  return (
    <div>
      <h1 className="text-xl font-bold">Edit Daily Consumption Product</h1>
      <h2>
            ...
            <button
              ...
              onClick={() => {
                if (applicationState.isEditMode) {
                  ...
                  updateProductDailyConsumptionData(selectedProduct);
...
export default DailyConsumptionEditEntry;
